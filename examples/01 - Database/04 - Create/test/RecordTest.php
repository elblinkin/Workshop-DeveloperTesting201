...
class RecordTest extends DBUnitTestCase {
    ...
    public function testGetField_newRecord() {
        $record = new Record(
            $this->getPDO(),
            'user',
            array()
        );
        $this->assertNull($record->getField('id'));
    }
    ...
    public function testSetField_newRecord() {
        $record = new Record(
            $this->getPDO(),
            'user',
            array()
        );
        $record->setField('name', 'Sally');

        $this->assertEquals('Sally', $record->getField('name'));
    }
    ...
    public function testStore_newRecordNotEdited() {
        $record = new Record(
            $this->getPDO(),
            'user',
            array()
        ...
        $this->assertFalse($record->store());
    }

    public function testStore_newRecordModified() {
        $record = new Record(
            $this->getPDO(),
            'user',
            array()
